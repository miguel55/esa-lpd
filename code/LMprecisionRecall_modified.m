...
% Code based on the LabelMeToolbox LMprecisionRecall.m function
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [RET, REL, RETREL, ndx] = LMprecisionRecall_modified(retrievedBoundingBox, annotation, objectname, mindetectablesize)
...
% have been detected (RETREL) and the class of every bounding box (ndx).
%
...
ndx = [];
for i = 1:RET
    % If the retrieved bounding box center does not deviate more than 50 % 
    % of the size of the real license plate from the real center (the
    % tightness of the bounding box is measured with the Dice coefficient)
