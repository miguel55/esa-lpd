...
% Code based on the LabelMeToolbox LMcookimage.m function
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [newannotation, newimg, crop, scaling, err, msg] = LMcookimage_modified(annotation, img, varargin)
% Transforms an image and the annotations without modifying scale.
%
% [newannotation, newimg, crop, scaling, err, msg] = LMcookimage_modified(annotation, img, paramteters);
...
if ~isempty(objectname) | ~isempty(polygoninstance)
    ...
    for i = 1:Ninstances
        scaling(i) = 1; % Not modifying the scale
